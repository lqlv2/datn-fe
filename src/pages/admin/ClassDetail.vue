    ...
    <a-spin :spinning="loading">
      ...
      <a-tabs v-model:activeKey="activeTabKey" class="detail-tabs">
        ...
        <a-tab-pane key="documents" tab="Documents">
          ...
          <a-empty v-if="!documents || documents.length === 0" description="No documents available for this class"/>
          ...
          <div v-else>
            ...
            >
              ...
              <template #action="{ record, text }">
                <a-space>
                  <a-button danger type="primary"  size="small" @click="showDeleteDocumentConfirm(record)">
                    <delete-outlined/>
                    Delete
                  </a-button>
                </a-space>
      ...
      >
        <a-form :model="documentForm" layout="vertical" ref="documentFormRef">
          ...
          <a-form-item label="File" name="file" :rules="[{ required: true }]">
            <a-upload

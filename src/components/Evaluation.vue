...
import { useEvaluationStore } from "@/stores/evaluationStore"; // Assuming you have an evaluation store
...
const handleOk = async () => {
  if (selectedEvaluation.value) {
    updateEvaluation(selectedEvaluation.value);
  } else {
    createEvaluation(newEvaluation.value);
  }
    ...
    <a-modal v-model:open="isModalOpen" title="Evaluation" @ok="handleOk">
      <a-form layout="vertical">
        <a-form-item label="Intern" required>
          <a-select
            v-model:value="newEvaluation.internId"
        ...
        <a-form-item label="Score" required>
          <a-input-number
            v-model:value="newEvaluation.score"
            :min="1"
            :max="5"
          />
        </a-form-item>
        ...
        <a-form-item label="Feedback">
          <a-textarea
            v-model:value="newEvaluation.feedback"
